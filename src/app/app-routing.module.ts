...
const routes: Routes = [
  ...
  { path: 'admin-activity-creator', canActivate: [SessionGuard, RoleGuard], component: ActivityCreatorComponent },
  { path: 'admin-activity-modifier', canActivate: [SessionGuard, RoleGuard], component: ActivityModifierComponent },
